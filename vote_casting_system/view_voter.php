			...
			<center>
				<table border='1'>
					...
					<tr>
						...
						<td><a href="edit_voter.php?voter_id=<?php echo $blog_info['voter_id'];?>" class="btn btn-primary"> EDIT</a>
						<a href="?status=delete&&voter_id=<?php echo $blog_info['voter_id'];?>"class="btn btn-danger"> Delete</a></td>
