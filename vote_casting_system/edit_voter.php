	      ...
	      if($db_connect){
			...
			$db_select=mysqli_select_db($db_connect,'vot');
			 ...
			 die('connection fail'.mysqli_error($db_connect));
				...
				$imam="UPDATE voter SET voter_name='$_POST[voter_name]',user_name='$_POST[user_name]',password='$pass',mobile='$_POST[mobile]',dob='$_POST[dob]',choice_btn='$_POST[choice_btn]',image='$dst1' WHERE voter_id='$_POST[voter_id]'";
