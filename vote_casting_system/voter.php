...
<html lang="en">
  ...
  <body>
  <div class="content">
  <h1> <marquee>  You can ADD DELETE and UPDATE Voters informtion here </marquee></h1>
  </div>
	<div class="page-wrap">
				...
				<div class="col-md-6 col-md-offset-2">
					<form action="ladv.php" method="post" enctype="multipart/form-data" >
					  ...
					  <div class="form-group">
						...
						<input type="text" class="form-control" name="voter_name" placeholder="Type Voters Name Here" required maxlength="30">
					  </div>
					  <div class="form-group">
						<label for="Name">User Name</label>
						<input type="text" class="form-control" name="user_name" placeholder="Type Voters user Name Here" required>
					  </div>
					   <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<input type="number" class="form-control" name="mobile" placeholder=" Example : 01716491735" required>
					  </div>
					  <div class="form-group">
